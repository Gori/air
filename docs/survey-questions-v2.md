...
- Usage categories always appear as: Intro slide → Matrix slide (same four‑point scale + Not applicable to my role).
...
- Prompt: “Which AI tools or features do you use in your day‑to‑day? How often and for what?”
...
8) Human‑led work — what should stay human (and roughly how much)
- Type: Opinion scale (1–5) + optional text
...
9) Intro — Business & Productivity (what this section covers)
- Type: Statement (Intro)
...
10) Matrix — Business & Productivity (required)
- Type: Matrix
- Items with explanations:
...
11a) Training effectiveness (conditional)
- Type: Opinion scale (1–5) + optional text
...
11b) Training needs (conditional)
- Type: Long Text (skippable)
...
13) Intro — Creative & Content (what this section covers)
- Type: Statement (Intro)
...
14) Matrix — Creative & Content (required)
- Type: Matrix
- Items with explanations:
...
17) Intro — Decision Support (what this section covers)
- Type: Statement (Intro)
...
18) Matrix — Decision Support (required)
- Type: Matrix
- Items with explanations:
...
22) Intro — Personal Assistance (what this section covers)
- Type: Statement (Intro)
...
23) Matrix — Personal Assistance (required)
- Type: Matrix
- Items with explanations:
...
26) Intro — Security & Moderation (what this section covers)
- Type: Statement (Intro)
...
27) Matrix — Security & Moderation (required)
- Type: Matrix
- Items with explanations:
